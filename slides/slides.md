...
## (And how I unintentionally learned to love Powershell)
...
This is the link to this slide deck. Note the companion repo to this presentation if you are interested.
...
Powershell and VS Code certainly seem made for each other. I enjoy writing Powershell in Neovim. Any editor with LSP support should be able to work with the PowerShellEditorServices language server. Powershell ISE does not support modern Powershell.
...
The language features themselves have caused me to warm up to Powershell more than anything. So I thought I would write a not very necessary tool in front of your very eyes. And, as we go, highlight some bits of the language I have found attractive.
